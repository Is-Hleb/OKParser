...
//        }
        ...
        ParserType::insert([
            [
                'index' => '1',
                'name' => 'Подписчики пользователей'
            ],
            [
                'index' => '2',
                'name' => 'Посты пользователя'
            ],
            [
                'index' => '3',
                'name' => 'Друзья'
            ...
            [
                'index' => '8',
                'name' => 'Пользователи по городу'
            ],
            [
                'index' => '9',
                'name' => 'Список групп по пользователя'
            ],
            [
                'index' => '11',
                'name' => 'Посты со страницы пользователя'
            ],
            [
                'index' => '12',
